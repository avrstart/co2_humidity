...
struct ili9163_operations {
    void (*ili9163_delay_ms) (uint32_t ms);
    void (*ili9163_spi_send) (uint8_t *data);
    void (*ili9163_write_cs) (uint8_t state);
    void (*ili9163_write_reset) (uint8_t state);
    void (*ili9163_write_datacom) (uint8_t state);
};
